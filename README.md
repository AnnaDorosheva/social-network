...
Приложение социальной сети. Написано на React/Redux. В качестве API используется база данных для обучающихся, поэтому профили практически не заполнены, созданы для обучения.
